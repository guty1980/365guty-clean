...
export function MovieCard({ movie, onPlay, className = "" }: MovieCardProps) {
  ...
  const handlePreviewPlay = (content: Movie | Series) => {
    // Como sabemos que este es un MovieCard, content siempre será Movie
    onPlay(content as Movie);
  };
